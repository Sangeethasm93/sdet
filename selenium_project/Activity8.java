...
public class Activity8 {
	...
	public void setup() throws IOException {
		...
		/*
		 * prop = new Properties(); ip = new
		 * FileInputStream("//NewProject//src//Seleniumproject//Staticvalues.properties"
		 * ); prop.load(ip);
		 */
	 ...
	 * 
	 * String Uname = prop.getProperty("username"); String Pwd =
	 * prop.getProperty("password"); WebElement Username =
	 * driver.findElement(By.id("user_login")); WebElement Password =
	 * driver.findElement(By.id("user_pass")); Username.sendKeys(Uname);
	 * Password.sendKeys(Pwd); WebElement loginbutton =
	 * driver.findElement(By.xpath("//input[@value='Log In']"));
	 * loginbutton.click(); Thread.sleep(5000); WebElement loggedin =
